...
- Every screen brief must include these exact uppercase section labels inside description: SCREEN PURPOSE, INFORMATION HIERARCHY, LAYOUT ANATOMY, KEY COMPONENTS, PREMIUM DESIGN DECISIONS, INTERACTION, MUST PRESERVE.
...
- Screen brief description sections: each description should usually be 900-1800 chars and MUST contain these seven screen-specific sections in exact order:
  * SCREEN PURPOSE: What exact job this screen performs and what the user is trying to accomplish.
  * INFORMATION HIERARCHY: What information/actions appear first, second, third and why.
  * LAYOUT ANATOMY: Concrete viewport structure from top to bottom, including major regions, containment, scrolling behavior, overlaps, asymmetry, and spatial relationships.
