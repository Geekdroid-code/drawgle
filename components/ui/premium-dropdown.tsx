      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={cn(
              "absolute z-50 bg-white dark:bg-[#1b1b1b] border border-slate-950/[0.08] dark:border-white/[0.08] shadow-[0_20px_70px_rgba(15,23,42,0.15)] dark:shadow-[0_20px_70px_rgba(0,0,0,0.55)] overflow-hidden",
          ...
          >
            ...
            <div ref={contentRef} className="w-max min-w-full">
              ...
              >
                ...
                {children ? (
                  // Custom content handler (e.g. search filter lists)
                  ...
                  <ul className="flex flex-col gap-0.5 m-0 p-0 list-none">
                    {items.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          {/* Hover/Active background pill indicator */}
                          {showIndicator && (
                            <motion.div
                          ...
                          {/* Left bar accent line indicator */}
                          {showIndicator && (
                            <motion.div
                              layoutId="leftBar"
                              className={cn(
