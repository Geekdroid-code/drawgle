...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-8 px-6 mt-auto bg-white border-t border-gray-100">
      ...
      />
            <h3 className="text-2xl font-bold text-gray-900 hover:text-[#1b7fcccc] transition-colors">
              Unrealshot AI
            </h3>
            </Link>
          ...
          <div className="flex gap-4">
            <a
              ...
              className="w-10 h-10 hover:bg-gray-100 bg-[#1b7fcccc] rounded-full flex items-center justify-center transition-colors group"
            >
  ...
  const photoshootCategories = {
    'Headshots': [
      ...
      { href: '/ai-doctor-headshots', label: 'Doctor Headshots' },
      { href: '/ai-lawyer-headshots', label: 'Lawyer Headshots' },
