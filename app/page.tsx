...
export default function HomePage() {
  return (
    <main className="min-h-screen dg-dashed-grid-bg text-neutral-950">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-5 py-6 sm:px-8 lg:px-10">
        <header className="flex items-center justify-between border-b border-slate-950/[0.08] pb-5">
          <Link href="/" className="flex items-center gap-3 text-sm font-medium tracking-[0.18em] text-neutral-950 uppercase">
            <span className="flex h-9 w-9 items-center justify-center rounded-full dg-control text-[11px] font-semibold tracking-[0.24em]">
              DG
            </span>
            Drawgle
          </Link>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="inline-flex h-10 items-center rounded-full dg-control px-4 text-sm font-medium text-neutral-700 transition hover:text-neutral-950"
            >
              Sign in
            </Link>
            <Link
              href="/project/new"
              className="inline-flex h-10 items-center gap-2 rounded-full dg-button-primary px-4 text-sm font-medium text-white transition"
            >
              Open workspace
          ...
          <div className="grid w-full gap-12 lg:grid-cols-[minmax(0,1.05fr)_360px] lg:items-end">
            <div className="max-w-4xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/project/new"
                  className="inline-flex h-12 items-center gap-2 rounded-full dg-button-primary px-5 text-sm font-medium text-white transition"
                >
                  Enter the workspace
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  href="/login"
                  className="inline-flex h-12 items-center rounded-full dg-control px-5 text-sm font-medium text-neutral-700 transition hover:text-neutral-950"
                >
                  Sign in
                </Link>
              </div>
            ...
            <div className="grid gap-3">
              {[
                ...
                <div key={item.title} className="dg-panel-flat px-5 py-4 backdrop-blur-sm">
