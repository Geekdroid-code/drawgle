...
export default function Footer() {
  const footerLinks = {
    ...
    Resources: [
      ...
      { href: '/vs/figma-ai', label: 'vs Figma AI' },
      { href: '/vs/app-alchemy', label: 'vs App Alchemy' },
      { href: '/vs/screensdesign', label: 'vs ScreensDesign' },
    ],
    Tools: [
      { href: '/tools/image-splitter', label: 'Image Splitter' },
      { href: '/tools/green-screen-remover', label: 'Green Screen Remover' },
      { href: '/tools/app-store-preview', label: 'App Store Preview' },
      { href: '/tools/screenshot-design', label: 'Screenshot Design' },
    ],
    Legal: [
    ...
    <footer className="w-full py-12 px-6 mt-auto bg-white border-t border-gray-100">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          {/* Link groups */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 w-full mt-8 md:mt-0">
        ...
        {/* Bottom copyright */}
        <div className="border-t border-gray-200 mt-12 pt-8 text-center md:flex md:items-center md:justify-between">
