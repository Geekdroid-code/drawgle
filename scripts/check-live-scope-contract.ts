...
const prompt = "An AI photo restoration and photo animation app inspired by the attached reference UI. Must have 2 step thoughtfully planned onboarding screen, one login/signup screen and 1 home screen.";
